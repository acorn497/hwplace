...
export const Panel = () => {
  ...
  return (
    <div className={`bg-white/90 backdrop-blur-sm border transition-normal duration-200 ease-in-out w-150 ${activeTool === 0 ? "h-0 border-slate-900/0 shadow-none" : "h-75 border-slate-900/10 shadow-sm"} rounded-lg relative flex flex-row overflow-hidden`}>
